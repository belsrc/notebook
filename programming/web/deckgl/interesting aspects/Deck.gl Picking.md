...
It encodes the given index using a combination of [bitwise AND (`&`)](Bitwise%20Operations.md#bitwise%20AND%20(`&`)) and [bitwise right shifts](Bitwise%20Operations.md#Logical%20Shifting%20(`<<`,%20`>>`)).
