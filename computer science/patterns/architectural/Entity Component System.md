...
- **Performance:** Systems can function efficiently by using arrays of components, which enables better utilization of [CPU cache](../../CPU%20Cache.md) [locality](../../Locality%20of%20Reference%20and%20Memory%20Locality.md) and parallelism.
...
Object-oriented structures can distribute data throughout memory, which may reduce [CPU cache](CPU%20Cache.md) efficiency. By adopting a data-oriented design that utilizes flat arrays to store components, [memory locality](Locality%20of%20Reference%20and%20Memory%20Locality.md) can be improved.
