...
**Review posture:** Verify against your conventions and constraints explicitly. Check that the output does not violate anything in your `CLAUDE.md` or skill definitions. The model will produce code that looks correct to an outside reviewer but may violate a team-specific invariant. This is the tribal knowledge gap described in [1.6 Domain Knowledge](1.6%20Domain%20Knowledge.md).
